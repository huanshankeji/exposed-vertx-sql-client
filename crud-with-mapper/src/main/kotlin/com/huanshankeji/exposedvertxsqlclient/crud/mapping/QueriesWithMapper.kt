...
import com.huanshankeji.exposedvertxsqlclient.getFieldExpressionSet
...
suspend fun <Data : Any> DatabaseClient<*>.executeQueryWithMapper(
    ...
    return executeWithMapping(query) { row -> dataQueryMapper.resultRowToData(row.toExposedResultRow(fieldExpressionSet)) }
}
